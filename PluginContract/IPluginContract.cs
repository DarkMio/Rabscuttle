...
namespace PluginContract {
    public interface IPluginContract {
        ...
        /// <summary> Called when a private message was sent and received by the bot. Careful: This can be in a channel too! </summary>
        /// <param name="message">The network message received.</param>
        void OnPrivMsg(NetworkMessage message);
        /// <summary> Called when a notice message was sent and received by the bot. </summary>
        /// <param name="message">The network message received.</param>
